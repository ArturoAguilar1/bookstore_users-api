...
import (
	"fmt"
	"github.com/ArturoAguilar1/bookstore_users-api/datasources/mysql/users_db"
	"github.com/ArturoAguilar1/bookstore_users-api/utils/errors"
	"github.com/ArturoAguilar1/bookstore_users-api/utils/mysql_utils"
)
...
func (user *User) FindByStatus(status string) ([]User, *errors.RestErr) {
	...
	defer rows.Close() //Sino dejo conexiones abiertas con la base de datos
